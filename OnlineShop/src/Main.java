...
public class Main
{
    ...
    {   
        ...
        clients[0] = new Customer("Jeniffer", 1289, "female", 23, 3,7);
        clients[1] = new Customer("Peter", 194, "male", 12, 2,4);
        clients[2] = new Customer("Dolores", 1394, "female", 75, 6,5);

        clients[0].showAllBoughtProducts(products);
        clients[0].addNewPurchase(4, 6, 3);

        clients[0].showAllBoughtProducts(products);
        clients[1].showAllBoughtProducts(products);
        clients[2].showAllBoughtProducts(products);
