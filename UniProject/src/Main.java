...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        //todo написать базу данных клиентов
        //todo написать бд номеров отеля
        //todo спросить правильно ли писать логин в админе
        //todo спросить почему за пределами мэйн метода не создаются объекты
        //todo хотя это очевидно, но обидно
    }
}
